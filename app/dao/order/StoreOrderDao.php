...
class StoreOrderDao extends BaseDao
{
     ...
     * @return float
     */
    public function totalSalesByUser(int $uid = 0,string $start_pay_time = '',string $end_pay_time = '')
    {
        return $this->search(['pid' => 0, 'paid' => 1, 'is_del' => 0,'start_pay_time'=>$start_pay_time,'end_pay_time'=>$end_pay_time])
            ->sum('pay_price');
    }
