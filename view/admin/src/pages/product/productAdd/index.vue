	...
	<Card :bordered="false" dis-hover class="ivu-mt">
      ...
      >
		...
		<!--  <Col span="24">
		  ...
		  <!--
		  <Col span="24">
            <FormItem label="单品提成：" prop="product_award">
              <Input
                v-model="formValidate.store_name"
                placeholder="请输入单品提成"
                v-width="'50%'"
          ...
          -->
		  <!-- formValidate.product_award ,oneFormValidate[0].product_award -->
		  <Col span="24" class="asterisk">
				<div class="asteriskInfo">*</div>
				<FormItem label="单品提成：">
				    <InputNumber
				      v-model="formValidate.product_award"
				      :min="0"
				      :max="99999999"
				      v-width="'50%'"
				    ></InputNumber>
      ...
      <Col span="24" v-if="formValidate.video_open">
        <FormItem label="上传视频：" prop="video_link">
          ...
          <div class="tips">建议使用云存储保存视频，<router-link :to="{ path: '/admin/setting/storage' }">配置云存储</router-link>，建议时长：9～30秒，视频宽高比16:9
				 ...
				 <Col span="24">
				   <FormItem label="服务保障：">
				     <CheckboxGroup
				 	  ...
				 	  class="checkAlls"
				     >
				       <Checkbox :label="item.id" v-for="(item,index) in ensureData" :key="index">{{item.name}}</Checkbox>
				     </CheckboxGroup>
             <div class="tips">
               <Poptip placement="bottom" trigger="hover" width="256" transfer padding="8px">
                 <a>查看示例</a>
